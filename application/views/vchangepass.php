<html>
<head>
	<title>SIAP - Sistem Informasi Apk Pembiayaan</title>
	...
	<script type="text/javascript" src="<?php echo config_item('base_assets');?>MessageBox.js?cb=<?php echo time()?>"></script>
	...
	<script type="text/javascript" src="<?php echo config_item('base_js');?>change_pass.js?cb=<?php echo time()?>"></script>
</head>
<html>	