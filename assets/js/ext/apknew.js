...
Ext.onReady(function() {
	...
	var txtSelisihDp = {
		border:false,
     	...
     	anchor: '80%',
     	emptyText: ' ',
     	fieldLabel:'Selisih Total DP : Rp.                           ',
     	labelStyle:'font-weight:bold;margin-left:10px;font-size:15px',
     	fieldStyle: 'font-size:18px;color:#FF0000;margin-left:40px;margin-top:1px',
     	id: 'txtSelisihDp',	
		name: 'txtSelisihDp',
		value: 0,
   		padding: 0,
	...
	function angsdimukaB() {

		var dimuka = Ext.getCmp('cboDimukaB').getValue();

		if(dimuka=='Y'){
			var kali = Ext.getCmp('txtDimukaKaliB').getValue();
		var angsuran = Ext.getCmp('txtAngsuranB').getValue();
		
		
		var xtotal = kali * angsuran;
		Ext.getCmp('txtAngsuranDimukaB').setValue(xtotal);
		}
	...
	function selisihDpB() {
		...
		var totaltrans = Ext.getCmp('txtTotalTransB').getValue();
		var totalDP = Ext.getCmp('txtTotalDpB').getValue();
		var biayaadmin = Ext.getCmp('txtBiayaAdmB').getValue();
		var premigross = Ext.getCmp('txtPremiGrosB').getValue();
		var preminet = Ext.getCmp('txtPremiNetB').getValue();
		var dimuka = Ext.getCmp('txtAngsuranDimukaB').getValue();
		var uangmuka = Ext.getCmp('txtUangMukaB').getValue();
		var pokok = Ext.getCmp('txtPokokPembiayaanDealerB').getValue();
		var grosfix = Ext.getCmp('txtPremiGrosFixB').getValue();
		...
		if(fix>0){
			Ext.getCmp('txtAsuransiDealerB').setValue(fix);
			Ext.getCmp('txtUangMukaB').setValue(fix2);
			Ext.getCmp('txtUangMuka2B').setValue(fix2);
			Ext.getCmp('txtAsuransiKonsumenB').setValue(fix);
		 ...
		 //document.getElementById("total_trx").value=fix;
			...
			Ext.getCmp('txtUangMukaB').setValue(fix2);
			Ext.getCmp('txtUangMuka2B').setValue(fix2);
			Ext.getCmp('txtAsuransiDealerB').setValue(fixed2);
			Ext.getCmp('txtAsuransiKonsumenB').setValue(fixed2);
			var fixed = fix;
	...
	function bungaFlatB() {
		...
		var otr = Ext.getCmp('txtHargaOTRdealerB').getValue();
		var tenor = Ext.getCmp('txtTenorB').getValue();
		var bungad = Ext.getCmp('txtBungaDealerB').getValue();
		var pembiayaan = Ext.getCmp('txtPokokPembiayaanDealerB').getValue();
		//var te = Ext.getCmp('txtPokokPembiayaanDealer').getValue();
		...
		var xfuture = '0';
		var cbDimuka = Ext.getCmp('cboDimukaB').getValue();
		...
		Ext.getCmp('txtBungaFlatB').setValue(bungaflat);
		Ext.getCmp('txtBungaFlatDealerB').setValue(fix);
		Ext.getCmp('txtBungaFlat3B').setValue(bungaflat);

		Ext.getCmp('txtBungaFlat4B').setValue(fix);


		var uangmukadealer = Ext.getCmp('txtUangMukaDealerpB').getValue();
		var uangmuka1 =  uangmukadealer / otr * 100;


		Ext.getCmp('txtUangMukaDealerlabelB').setValue(uangmuka1.toFixed(2));
		Ext.getCmp('txtUangMukaDealer2B').setValue(uangmuka1.toFixed(2));
	...
	function pokokpembiayaanB() {
		var otr = Ext.getCmp('txtHargaOTRdealerB').getValue();
		var uangmuka = Ext.getCmp('txtUangMukaDealerpB').getValue();

		var asuransi = Ext.getCmp('txtAsuransiDealerB').getValue();		

		var angs = Ext.getCmp('txtAngsuranBulanDealerB').getValue();		

		var tenor = Ext.getCmp('txtTenor2B').getValue();		

		var xpiu = angs * tenor;
		var xtotal = otr - uangmuka + asuransi;

		Ext.getCmp('txtPokokPembiayaanDealerB').setValue(xtotal);
		Ext.getCmp('txtPokokPembiayaanKonsumenB').setValue(xtotal);


		Ext.getCmp('txtPiutangKonsumenB').setValue(xpiu);
		Ext.getCmp('txtPiutangDealerB').setValue(xpiu);
	...
	function bungaB() {
		...
		var piutang = Ext.getCmp('txtPiutangDealerB').getValue();		
		...
		Ext.getCmp('txtBungaDealerB').setValue(xbunga);
		Ext.getCmp('txtBungaKonsumenB').setValue(xbunga);
	...
	function PremiNettB() {
		...
		var assgros = Ext.getCmp('txtPremiGrosFixB').getValue();
		...
		Ext.getCmp('txtPremiNetB').setValue(hasil);
	...
	function PremiGrossFixB() {

	var tjh = Ext.getCmp('txtBiayaTjHB').getValue();
													var premi = Ext.getCmp('txtPremiGrosB').getValue();
													var perluasan = Ext.getCmp('txtPerluasanB').getValue();
													 var total = parseInt(tjh) + parseInt(premi) + parseInt(perluasan) + 25000;

													 Ext.getCmp('txtPremiGrosFixB').setValue(total);
													  //Ext.getCmp('txtPremiGrosFix2').setValue(total);
	...
	function uangmukaB() {
    	...
    	Ext.getCmp('txtUangMuka2B').setValue(xtotal);
	...
	function LuxTaxB() {
		var xJenisPiu = Ext.getCmp('cboJenisPiuB').getValue();
		var xPola = Ext.getCmp('cboPolaB').getValue();
		var xTenor = Ext.getCmp('txtTenorB').getValue();
		var xTenor = Ext.getCmp('txtHargaOTRB').getValue();
		...
		Ext.Ajax.request({
			...
			params: {
				...
				'fd_lama_angsuran': Ext.getCmp('txtTenorB').getValue(),
			...
			success: function(response) {
				...
				if (xtext.sukses === true) {
					//	Ext.getCmp('cboGL').setValue(xtext.kdacno);
						Ext.getCmp('txtBiayaAdmB').setValue(xtext.hasil);
	...
	var txtPolaB = {
		...
		var txtKodeCabangDel = {
		anchor: '100%',
		fieldLabel: 'Email Cabang',
		id: 'txtKodeCabangDel',
		maxLength: 30,
		hidden:true,
		name: 'txtKodeCabangDel',
		xtype: 'textfield'
		};
		...
		var gridHeader = Ext.create('Ext.grid.Panel', {
			...
			listeners: {
				...
				Ext.getCmp('txtKodeCabangDel').setValue(record.get('fs_kode_cabang'));
				
				var combo4 = Ext.ComponentQuery.query('#idKoreksi')[0];

				if(record.get('fs_keputusan_kredit')=='Y' && record.get('fs_flag_keputusan_cabang')==1){
						combo4.setDisabled(true);
					}
					else if(record.get('fs_keputusan_kredit')=='Y' && record.get('fs_flag_keputusan_cabang')==1 && record.get('fs_flag_keputusan_pusat')==1){
						combo4.setDisabled(true);
					}
					else {
				...
				{	
					...
					var kodeCab = Ext.getCmp('txtKodeCabang').getValue();
...
/*
		...
		function fnHapusAPK() {
			Ext.Ajax.request({
				method: 'POST',
				url: 'apknew/deleteapk',
				params: {
					'fn_no_apk': Ext.getCmp('txtNoAPK2').getValue(),
					'fs_kode_cabang': Ext.getCmp('txtKodeCabangDel').getValue()
				},
				success: function(response) {
					var xtext = Ext.decode(response.responseText);
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------	
	...
	var txtNoNpwp = {
		...
		keyup: function(field) {
			var newValue2 = field.getValue();

			var newValue = newValue2.replace(/[.-]/g, "");
	...
	var txtKodeCabangKonsumen = {
		...
		emptyText: 'Enter an Address',
		fieldLabel: 'Alamat Korespondensi',
		id: 'txtKodeCabangKonsumen',
		name: 'txtKodeCabangKonsumen',
		xtype: 'textfield'
	};
		...
		listeners: {
			beforeload: function(store) {
				Ext.apply(store.getProxy().extraParams, {
					...
					'fs_kode_cabang': Ext.getCmp('txtKodeCabangDealerB').getValue()
				});
			}
		}
	});
		...
		listeners: {
			beforeload: function(store) {
				Ext.apply(store.getProxy().extraParams, {
					...
					'fs_kode_cabang': Ext.getCmp('txtKodeCabangKonsumen').getValue()
				});
			}
		}
	});
		...
		listeners: {
			beforeload: function(store) {
				Ext.apply(store.getProxy().extraParams, {
					...
					'fs_kode_cabang': Ext.getCmp('txtKodeCabangB').getValue()
				});
			}
		}
	});
	...
	var winGridPolaTransaksi = Ext.create('Ext.grid.Panel', {
		...
		listeners: {
			itemdblclick: function(grid, record)
			{
				...
				Ext.getCmp('txtPola').setValue(record.get('fs_nilai2_referensi'));
	...
	var winGridPolaTransaksiB = Ext.create('Ext.grid.Panel', {
		...
		listeners: {
			itemdblclick: function(grid, record)
			{
				...
				Ext.getCmp('txtPolaB').setValue(record.get('fs_nilai2_referensi'));
		...
		enableKeyEvents: true,
		 listeners: {
		 	keyup: function(field) {
				...
				var kondisi = Ext.getCmp('txtPola').getValue();
															var n =  Ext.getCmp('txtPola').getValue().length;
		...
		xtype: 'textfield',
		 listeners: {
												    'change': function(field,newValue){
												      ...
												      var kondisi = Ext.getCmp('txtPolaB').getValue();
															var n =  Ext.getCmp('txtPolaB').getValue().length;
				...
				success: function(response) {
		    		...
		    		var fix = parseInt(premi) + parseInt(perluasan) + parseInt(tjh) + 25000;
					 ...
					 var total = fix;
							...
							Ext.getCmp('txtSelisihDp').setValue('0');
							if (xtotal > 0) {
					    	Ext.getCmp('txtUangMuka').setValue(xtotal);
					    	//Ext.getCmp('txtUangMuka2').setValue(xtotal);
							Ext.getCmp('txtUangMukaDealerp').setValue(xtotal);
	...
	var checktjh2 = {
		...
		change : {
		    fn : function(checkbox, checked){
		    	...
		    	if(checked==true){
		var tjh = Ext.getCmp('txtBiayaTjHB').getValue();
		var jenis_kendaraan = Ext.getCmp('txtJenisKendaraanB').getValue();
		var komersil = Ext.getCmp('cboKomersilB').getValue();
		var otr = Ext.getCmp('txtHargaOTRB').getValue();
		var asuransi = Ext.getCmp('txtNilaiAsuransiB').getValue();
		var tenor = Ext.getCmp('txtTenorB').getValue();
		var tahun_pencairan = Ext.getCmp('txtRefnodtB').getValue();
		var usia_kendaraan = Ext.getCmp('txtTahunB').getValue();
		var pola_transaksi = Ext.getCmp('cboPolaB').getValue();
		var wilayah_asuransi = Ext.getCmp('txtWilayahAsuransiB').getValue();
			...
			Ext.Ajax.request({
				...
				success: function(response) {
					...
					if (xtext.sukses === true) {
						...
						//alert(xtext.hasil);
						//alert(xtext.hasil)
							Ext.getCmp('txtBiayaTjH2B').setValue(xtext.hasil);

							  var tjh =  Ext.getCmp('txtBiayaTjH2B').getValue();
		    		 var perluasan =  Ext.getCmp('txtPerluasanB').getValue();
		    		 var premi =  Ext.getCmp('txtPremiGrosB').getValue();
		    		var fix = parseInt(premi) + parseInt(perluasan) + parseInt(tjh) + 25000;
					 //var premi = Ext.getCmp('txtPremiGrosFix').getValue();
					 var total = fix;
							...
							var xtotal = dp - admin - total - dimuka - totaltrans;
							Ext.getCmp('txtSelisihDpB').setValue('0');
							if (xtotal > 0) {
					    	Ext.getCmp('txtUangMukaB').setValue(xtotal);
					    	//Ext.getCmp('txtUangMuka2').setValue(xtotal);
							Ext.getCmp('txtUangMukaDealerpB').setValue(xtotal);
							...
							var combo1 = Ext.ComponentQuery.query('#txtBiayaTjHB')[0];
			...
			var tjh =  Ext.getCmp('txtBiayaTjH2B').getValue();
		    		...
		    		// PremiGrossFix();
					 ...
					 var total = fix;
					  ...
					  Ext.getCmp('txtPremiGrosFixB').setValue(total);
		    		  Ext.getCmp('txtBiayaTjHB').setValue(tjh2);
		    		  var totaltrans = Ext.getCmp('txtTotalTransB').getValue();
	...
	var cboStatusKawin = {
		...
		listeners: {
			change: function(field, newValue) {
				...
				var kondisi = Ext.getCmp('txtStatusKawin').getValue();

				//alert(kondisi);

				var combo1 = Ext.ComponentQuery.query('#txtNamaIstri')[0];
	...
	var txtKodeKendaraanB = {
		...
		labelAlign:'left',
		labelWidth:130,
		id: 'txtKodeKendaraanB',
		name: 'txtKodeKendaraanB',
		xtype: 'textfield'
	};
	...
	var txtTahunB = {
		...
		listeners: {
			keyup: function(field) {
				...
				var polaTrans = Ext.getCmp('cboPolaB').getValue();
				var jenispiutangs = Ext.getCmp('cboJenisPiuB').getValue();
				var tglapk = Ext.getCmp('txtRefnodtB').getValue();
				var jeniss = Ext.getCmp('cboJenisB').getValue();
				...
				if (polaTrans.trim() === '') {
					...
					Ext.getCmp('txtTahunB').setValue('0');
					return;
	...
	var winGridModelKendaraanB = Ext.create('Ext.grid.Panel', {
		...
		listeners: {
			itemdblclick: function(grid, record)
			{
				...
				Ext.getCmp('txtKodeKendaraanB').setValue(record.get('fs_kode_kendaraan_lama'));
												   ...
												   // bunga();
												    ...
												    //selisihDp();
															...
															if(hasil2 > 0){
																...
																Ext.getCmp('txtNilaiCairB').setValue(fixa);
																Ext.getCmp('txtNilaiCair3B').setValue(fixa);
															...
															// document.getElementById("total_trx2").value=fix2;
																...
																var fixed2 = format1(fixx2);
															 	...
															 	//alert(fixed2);
															 	 Ext.getCmp('txtNilaiCairB').setValue(fixed2);
															 	 Ext.getCmp('txtNilaiCair3B').setValue(fixed2);
	...
	var txtKodeCabangDealerB = {
		anchor: '80%',
		labelWidth:130,
		labelAlign:'right',
		hidden:true,
		id: 'txtKodeCabangDealerB',
		name: 'txtKodeCabangDealerB',
		xtype: 'textfield'
	};
	...
	var winGridDealerB = Ext.create('Ext.grid.Panel', {
		...
		listeners: {
			itemdblclick: function(grid, record)
			{
				...
				Ext.getCmp('txtKodeCabangDealerB').setValue(record.get('fs_kode_cabang'));
		...
		triggers: {
			reset: {
				...
				handler: function(field) {
					...
					Ext.getCmp('txtKodeCabangDealerB').setValue('');
		...
		listeners: {
			change: function(combo, value) {
				...
				if(value=='Y'){
					...
					var b = Ext.getCmp('txtUangMuka').getValue();
					var totalz = Ext.getCmp('txtPremiGrosFix').getValue();
					...
					Ext.getCmp('txtAngsuranDimuka').setValue(a);
												...
												var premi = Ext.getCmp('txtPremiGrosFix').getValue();
												var totaltrans = Ext.getCmp('txtTotalTrans').getValue();
												 var total = dp - admin - premi - totaltrans;
												 //alert(newValue);
		...
		listeners: {
			change: function(combo, value) {
				...
				if(value=='Y'){
					...
					var a = Ext.getCmp('txtAngsuranB').getValue();
					var b = Ext.getCmp('txtUangMukaB').getValue();
					var totalz = Ext.getCmp('txtPremiGrosFixB').getValue();


					Ext.getCmp('txtAngsuranDimukaB').setValue(a);
					
												var dp = Ext.getCmp('txtTotalDpB').getValue();
												var admin = Ext.getCmp('txtBiayaAdmB').getValue();
												var premi = Ext.getCmp('txtPremiGrosFixB').getValue();
												var totaltrans = Ext.getCmp('txtTotalTransB').getValue();
												 var total = dp - admin - premi - totaltrans;
												 //alert(newValue);
												...
												Ext.getCmp('txtUangMukaKonsumenpB').setValue(xtotal);
													...
													xtotals =  xtotal *(-1);		
												Ext.getCmp('txtUangMukaB').setValue(xtotals);
												Ext.getCmp('txtUangMuka2B').setValue(xtotals);
												Ext.getCmp('txtUangMukaDealerpB').setValue(xtotals);
												Ext.getCmp('txtUangMukaKonsumenpB').setValue(xtotals);
												}
					//Ext.getCmp('txtDimukaKali').setValue('1');
	...
	var winData = Ext.create('Ext.grid.Panel',{
		...
		tbar: [{
			...
			items: [{
				...
				{
					id: 'txtJenisPembiayaanPP',
					name: 'txtJenisPembiayaanPP',
					xtype: 'textfield',
					hidden: true
				},{
					id: 'txtNoBatch',
	...
	var winData2 = Ext.create('Ext.grid.Panel',{
		...
		tbar: [{
			...
			items: [{
				...
				{
					id: 'txtJenisPembiayaanPB',
					name: 'txtJenisPembiayaanPB',
					xtype: 'textfield',
					hidden: true
				}]
			},{
												 ...
												 listeners: {
													...
													if(total>=uangmukax){
														...
														if(fix>0){
															...
															Ext.getCmp('txtSelisihDp').setValue(fix);
														 //document.getElementById("total_trx").value=fix;
														}
									...
									items: [{
										...
										items: [
											Ext.create('Ext.ux.form.NumericField', {
												...
												var dimuka = Ext.getCmp('txtAngsuranDimukaB').getValue();
												var totaltrans = Ext.getCmp('txtTotalTransB').getValue();
												 var total = parseInt(dp) - parseInt(newValue) - parseInt(premi) - parseInt(dimuka) - totaltrans;
												 //alert(total);
											...
											Ext.create('Ext.ux.form.NumericField', {
												...
												listeners: {
													...
													var perluasan = Ext.getCmp('txtPerluasanB').getValue();
													var total1 = parseInt(premi)+parseInt(tjh)+parseInt(perluasan)+25000;
													Ext.getCmp('txtPremiGrosFixB').setValue(total1);
											...
											Ext.create('Ext.ux.form.NumericField', {
												...
												value: 0,
												 listeners: {
													...
													var uangmukax = Ext.getCmp('txtUangMuka2B').getValue();
													
													var totaltrans = Ext.getCmp('txtTotalTrans2B').getValue();
													var totalDP = Ext.getCmp('txtTotalDpB').getValue();
													var biayaadmin = Ext.getCmp('txtBiayaAdmB').getValue();
													var premigross = Ext.getCmp('txtPremiGrosB').getValue();
													var preminet = Ext.getCmp('txtPremiNetB').getValue();
													...
													if(total>=uangmukax){
														...
														Ext.getCmp('txtSelisihDpB').setValue(fix);
														}
													...
													var totalDP2 = Ext.getCmp('txtTotalDpB').getValue();
													var totaltranscair2 = Ext.getCmp('txtTotalTrans2B').getValue();
															var biayaadmin2 = Ext.getCmp('txtBiayaAdmB').getValue();
															var premigross2 = Ext.getCmp('txtPremiGrosB').getValue();
															var preminet2 = Ext.getCmp('txtPremiNetB').getValue();
															var dimuka2 = Ext.getCmp('txtAngsuranDimukaB').getValue();
															var uangmuka2 = Ext.getCmp('txtUangMukaB').getValue();
															var pokok2 = Ext.getCmp('txtPokokPembiayaanDealerB').getValue();
															...
															// document.getElementById("total_trx2").value=fix2;
																...
																var fixed22 = format1(fixx22);
															 	...
															 	//alert(fixed2);
															 	 Ext.getCmp('txtNilaiCairB').setValue(fixed22);
															 	 Ext.getCmp('txtNilaiCair3B').setValue(fixed22);
																//document.getElementById("total_trx2").value=fixed2;
															}
													},
												    'change': function(field,newValue){
...
function fnSavePengurus() {
	...
	function fnDeleteTransK(){
			...
			var	kode_cabang = Ext.getCmp('txtKodeCabangTransK').getValue();
			var no_apk = Ext.getCmp('txtNoApkTransK').getValue();
			var kode_trans = Ext.getCmp('txtKodeTransK').getValue();

										Ext.Ajax.request({
													method: 'POST',
													url: 'koreksi/delete_trans',
													params: {
														'kode_cabang': kode_cabang,
														'no_apk': no_apk,
...
function fnDuplikasi() {
		...
		var kode_cab = Ext.getCmp('txtKodeCabang').getValue();
		//alert(kode_cab);
			...
			success: function(response) {
				...
				if (xtext.sukses === true) {
					...
					if(xtext.hasil=='P' || xtext.hasil=='W'){
						...
						Ext.getCmp('txtKodeCabangKonsumen').setValue(xtext.fs_kode_cabang);
						Ext.getCmp('txtRefnodt').setValue(xtext.fd_tgl_apk);
						Ext.getCmp('txtUserDatebirth').setValue(xtext.fd_tanggal_lahir_konsumen);
						Ext.getCmp('txtSd').setValue(xtext.fs_masa_ktp_konsumen);
						Ext.getCmp('txtSelisihDp').setValue(xtext.fn_selisih_dp);
						Ext.getCmp('txtTotalTrans2').setValue(xtext.total_cair);
						Ext.getCmp('txtTotalTrans').setValue(xtext.total_trans);
						//document.getElementById('total_trx').value=xtext.fn_selisih_dp;
						Ext.getCmp('txtNoApkP').setValue(xtext.fn_no_apk);
						Ext.getCmp('txtJenisPembiayaanPP').setValue(xtext.fs_jenis_pembiayaan);
						...
						Ext.getCmp('txtPola').setValue(xtext.fs_jenis_pola_transaksi);
						Ext.getCmp('cboPola').setValue(xtext.fs_pola_transaksi);
						//alert(xtext.fs_jenis_pola_transaksi);
						...
						if(xtext.fs_skala_perusahaan_konsumen=='B'){
						var a='BESAR';
						}
						else if(xtext.fs_skala_perusahaan_konsumen=='K'){
							var a='KECIL';
						}
						else if(xtext.fs_skala_perusahaan_konsumen=='M'){
							var a='MENENGAH';
						}
						Ext.getCmp('cboSkalaPerusahaan').setValue(xtext.fs_skala_perusahaan_konsumen);
						Ext.getCmp('txtKodeSkalaPerusahaan').setValue(xtext.fs_kode_skala_perusahaan_konsumen);
						Ext.getCmp('txtStatusKawin').setValue(xtext.fs_kode_status_kawin);
						...
						Ext.getCmp('cboModelKendaraan').setValue(xtext.fs_merek_kendaraan);
						Ext.getCmp('txtModelKendaraan').setValue(xtext.fs_model_kendaraan);
						Ext.getCmp('txtJenisKendaraan').setValue(xtext.fs_jenis_kendaraan);
						Ext.getCmp('txtKodeKendaraan').setValue(xtext.fs_kode_kendaraan);
						...
						Ext.getCmp('txtTanggungan').setValue(xtext.fn_tanggungan_konsumen);
						Ext.getCmp('txtTanggalAngsBln').setValue(xtext.fn_tanggal_jatuhtempo_perbulan);
						

						Ext.getCmp('txtBiayaTjH').setValue(xtext.fn_biaya_tjh);
						var check = Ext.ComponentQuery.query('#checktjh')[0];
						//alert(xtext.fn_biaya_tjh);
						//alert(xtext.fn_biaya_tjh);
						if(xtext.fn_biaya_tjh!=0){
							 check.setValue(true);
						...
						Ext.getCmp('txtPremiGrosFix').setValue(xtext.fn_premi_asuransi);
						...
						//alert(a);
						//Ext.getCmp('total_trx').setValue(xtext.fn_selisih_dp);
						Ext.getCmp('txtPiutangDealer').setValue(xtext.fn_piutang_dealer);
						Ext.getCmp('txtPiutangKonsumen').setValue(xtext.fn_piutang_konsumen);
						Ext.getCmp('txtAngsuranBulanDealer').setValue(xtext.fn_angsuran_dealer);
						Ext.getCmp('txtAngsuranBulanKonsumen').setValue(xtext.fn_angsuran_konsumen);
						Ext.getCmp('cboAngsuranDibayarDealer').setValue(xtext.fs_angsuran_dibayar_dealer);
						Ext.getCmp('txtAsuransiKonsumen').setValue(xtext.fn_selisih_dp);
						Ext.getCmp('txtAsuransiDealer').setValue(xtext.fn_selisih_dp);
						Ext.getCmp('txtPokokPembiayaanDealer').setValue(xtext.fn_pokok_pembiayaan_dealer);
						Ext.getCmp('txtPokokPembiayaanKonsumen').setValue(xtext.fn_pokok_pembiayaan_konsumen);
						...
						Ext.getCmp('txtUangMukaDealerp').setValue(xtext.fn_uang_muka_dealer);
						Ext.getCmp('txtUangMukaKonsumenp').setValue(xtext.fn_uang_muka_dealer);
						...
						Ext.getCmp('txtTeleponIstri').setValue(xtext.fs_handphone_pasangan);
						...
						Ext.getCmp('txtTanggalAngs1').setValue(xtext.fd_tanggal_angsuran_pertama);
						Ext.getCmp('txtTglCair').setValue(xtext.fd_tanggal_perjanjian);
						...
						Ext.getCmp('txtKodeCabangB').setValue(xtext.fs_kode_cabang);
						Ext.getCmp('txtRefnodtB').setValue(xtext.fd_tgl_apk);
						Ext.getCmp('txtSelisihDpB').setValue(xtext.fn_selisih_dp);
						Ext.getCmp('txtTotalTrans2B').setValue(xtext.total_cair);
						Ext.getCmp('txtTotalTransB').setValue(xtext.total_trans);
						...
						Ext.getCmp('txtJenisPembiayaanPB').setValue(xtext.fs_jenis_pembiayaan);
						...
						Ext.getCmp('txtPolaB').setValue(xtext.fs_jenis_pola_transaksi);
						...
						Ext.getCmp('cboModelKendaraanB').setValue(xtext.fs_merek_kendaraan);
						Ext.getCmp('txtModelKendaraanB').setValue(xtext.fs_model_kendaraan);
						Ext.getCmp('txtJenisKendaraanB').setValue(xtext.fs_jenis_kendaraan);
						Ext.getCmp('txtKodeKendaraanB').setValue(xtext.fs_kode_kendaraan);
						...
						Ext.getCmp('txtPremiGrosFixB').setValue(xtext.fn_premi_asuransi);
						...
						Ext.getCmp('txtPiutangDealerB').setValue(xtext.fn_piutang_dealer);
						Ext.getCmp('txtPiutangKonsumenB').setValue(xtext.fn_piutang_konsumen);
						Ext.getCmp('cboAngsuranDibayarDealerB').setValue(xtext.fs_angsuran_dibayar_dealer);
						Ext.getCmp('txtAsuransiKonsumenB').setValue(xtext.fn_selisih_dp);
						Ext.getCmp('txtAsuransiDealerB').setValue(xtext.fn_selisih_dp);
						Ext.getCmp('txtAngsuranBulanDealerB').setValue(xtext.fn_angsuran_dealer);
						Ext.getCmp('txtAngsuranBulanKonsumenB').setValue(xtext.fn_angsuran_konsumen);
						...
						Ext.getCmp('txtUangMukaDealerpB').setValue(xtext.fn_uang_muka_dealer);
						Ext.getCmp('txtUangMukaKonsumenpB').setValue(xtext.fn_uang_muka_dealer);
						Ext.getCmp('txtUangMukaDealerlabelB').setValue(xtext.fs_uang_muka_dealer);
						Ext.getCmp('txtPokokPembiayaanDealerB').setValue(xtext.fn_pokok_pembiayaan_dealer);
						Ext.getCmp('txtPokokPembiayaanKonsumenB').setValue(xtext.fn_pokok_pembiayaan_konsumen);
						...
						Ext.getCmp('txtTanggalAngs1B').setValue(xtext.fd_tanggal_angsuran_pertama);
						Ext.getCmp('txtTglCairB').setValue(xtext.fd_tanggal_perjanjian);
						Ext.getCmp('txtTanggalAngsBlnB').setValue(xtext.fn_tanggal_jatuhtempo_perbulan);
	...
	function savePerluasan2() {
		...
		var store2 = gridPerluasan2.getStore();
			store2.each(function(record, idx) {
				xNama = xNama +'|'+ record.get('fs_nama_perluasan');
				xTenor = xTenor +'|'+ record.get('fs_tenor_perluasan');
			...
			Ext.Ajax.request({
				...
				if (xtext.sukses === true) {
					...
					var gros = Ext.getCmp('txtPremiGrosFixB').getValue();
					var gros2 = Ext.getCmp('txtPremiGrosFix2B').getValue();
					//alert(gros2);
					var perluasan1 = Ext.getCmp('txtPerluasanB').getValue();
					var perluasan2 = Ext.getCmp('txtPerluasan2B').getValue();
					...
					//var perluasan = Ext.getCmp('txtPerluasan').getValue();
					Ext.getCmp('txtPerluasanB').setValue(xtext.hasil);
					//var perluasan = Ext.getCmp('txtPerluasan').getValue();
						...
						Ext.getCmp('txtPerluasan2B').setValue(xtext.hasil);
						...
						if (xtotal > 0) {
							...
							var xqty = 0;
							 Ext.getCmp('txtPerluasanB').setValue(xtqy);
						}
					//vMask.hide();
				}
				...
				if (xtext.sukses2 === true) {
					...
					var perluasan = Ext.getCmp('txtPerluasanB').getValue();
					var total = parseInt(gros) - parseInt(perluasan);
					Ext.getCmp('txtPerluasanB').setValue(b);
					Ext.getCmp('txtPremiGrosFixB').setValue(total);
					fnMaskHide();
					//vMask.hide();
				}
	...
	function fnSaveTrans() {
			...
			var no_apk = Ext.getCmp('txtNoApkP').getValue();
			var kode_cabang = Ext.getCmp('txtKodeCabangKonsumen').getValue();
	...
	function fnSaveTrans2() {
			...
			var no_apk = Ext.getCmp('txtNoApkB').getValue();
			var kode_cabang = Ext.getCmp('txtKodeCabangB').getValue();
		...
		Ext.Ajax.request({
			...
			success: function(response) {
				...
				if (xtext.sukses === true) {
					...
					//alert(xtext.total_trans2);
					Ext.getCmp('txtTotalTransB').setValue(xtext.total_trans);
					Ext.getCmp('txtTotalTrans3B').setValue(xtext.total_trans);
					Ext.getCmp('txtTotalTrans2B').setValue(xtext.total_trans2);
					...
					if (xtotal > 0) {
						...
						var a=0;
						Ext.getCmp('txtTotalTransB').setValue(a);
					}
				}	
	...
	function NilaiCair() {
		...
		var fix2 = format(hasil2);

		if(hasil2 > 0){

			var fixa = format(hasil2);
			Ext.getCmp('txtNilaiCair').setValue(fixa);
			Ext.getCmp('txtNilaiCair3').setValue(fixa);
	...
	function PremiGrossB() {
		...
		Ext.Ajax.request({
			...
			success: function(response) {
				...
				if (xtext.sukses === true) {
					//	Ext.getCmp('cboGL').setValue(xtext.kdacno);
						Ext.getCmp('txtPremiGrosB').setValue(xtext.hasil);
	...
	function fnCekSave2() {
		if (this.up('form').getForm().isValid()) {
			...
			Ext.Ajax.request({
				method: 'POST',
				url: 'koreksi/CekSimpanBadan',
				params: {
				'fn_no_batch': '',
				'fs_kode_lokasi': Ext.getCmp('txtLembagaKeuangan1B').getValue(),
				'fn_no_apk': Ext.getCmp('txtNoApkB').getValue(),
				'fn_no_pjj': Ext.getCmp('txtNoPjjB').getValue(),
	...
	//LuxTax();
												    ...
												    var checktjh = Ext.getCmp('checktjh2').getValue();
													...
													if(checktjh==true){
													 ...
													 Ext.getCmp('txtPremiGrosFixB').setValue(totalz);

												  

													var newValue = Ext.getCmp('txtUangMukaB').getValue();

													 var dps = Ext.getCmp('txtTotalDpB').getValue();
														var admins = Ext.getCmp('txtBiayaAdmB').getValue();
														var premis = Ext.getCmp('txtPremiGrosB').getValue();
														var dimukas = Ext.getCmp('txtAngsuranDimukaB').getValue();
														var grosfixs = totalz;
														var totaltranss = Ext.getCmp('txtTotalTransB').getValue();
														
														
														//var xtotal = dps - admins - grosfixs - dimukas - totaltranss;
														//if (xtotal > 0) {
												    	//Ext.getCmp('txtUangMuka').setValue(xtotal);
												    	Ext.getCmp('txtUangMuka2B').setValue(newValue);
														Ext.getCmp('txtUangMukaDealerpB').setValue(newValue);
														Ext.getCmp('txtUangMukaKonsumenpB').setValue(newValue);
		...
		Ext.Ajax.request({
			...
			params: {
				...
				'fd_tanggal_perjanjian': Ext.Date.format(Ext.getCmp('txtTglCairB').getValue(), 'Y-m-d'),
				'fs_jenis_pembiayaan': Ext.getCmp('cboJenisB').getValue(),
				'fs_kode_lokasi': Ext.getCmp('txtLembagaKeuangan1B').getValue(),
				'fs_nomor_dealer': Ext.getCmp('txtLembagaKeuangan2B').getValue(),
				'fs_jenis_piutang': Ext.getCmp('cboJenisPiuB').getValue(),
				...
				'fs_kategori_perusahaan_konsumen': Ext.getCmp('txtKodeKategoriUsahaB').getValue(),
				...
				'fs_kode_kendaraan': Ext.getCmp('txtKodeKendaraanB').getValue(),
				'fs_merek_kendaraan': Ext.getCmp('cboModelKendaraanB').getValue(),
				'fs_model_kendaraan': Ext.getCmp('txtModelKendaraanB').getValue(),
				...
				'fn_angsuran_dealer': Ext.getCmp('txtAngsuranBulanDealerB').getValue(),
				'fn_uang_muka_konsumen': Ext.getCmp('txtUangMukaKonsumenpB').getValue(),
				'fn_asuransi_dikredit_konsumen': Ext.getCmp('txtAsuransiKonsumenB').getValue(),
				'fn_persen_bunga_flat_konsumen': Ext.getCmp('txtBungaFlat3B').getValue(),
				'fn_persen_bunga_efektif_konsumen': Ext.getCmp('txtBungaFlat4B').getValue(),
				'fn_bulan_masa_angsuran_konsumen': Ext.getCmp('txtTenorB').getValue(),
				'fn_kali_masa_angsuran_konsumen': Ext.getCmp('txtTenorB').getValue(),
				'fn_bunga_konsumen': Ext.getCmp('txtBungaKonsumenB').getValue(),
				'fn_angsuran_konsumen': Ext.getCmp('txtAngsuranBulanKonsumenB').getValue(),
				'fd_tanggal_angsuran_pertama': Ext.Date.format(Ext.getCmp('txtTanggalAngs1B').getValue(), 'Y-m-d'),
				'fn_tanggal_jatuhtempo_perbulan': Ext.getCmp('txtTanggalAngsBlnB').getValue(),
				'fs_cair_ke': Ext.getCmp('cboPencairanKeB').getValue(),
				'fs_uang_muka_bayar_di': Ext.getCmp('cboUangMukaB').getValue(),
				'fs_deposit_potong_pencairan': Ext.getCmp('cboDepositB').getValue(),
				'fs_atasnama_bank_pencairan': Ext.getCmp('txtRekeningCairB').getValue(),
				'fs_nama_bank_pencairan': Ext.getCmp('txtNamaBankB').getValue(),
				'fs_rekening_bank_pencairan': Ext.getCmp('txtNoRekCairB').getValue(),
				'fn_nilai_pencairan': Ext.getCmp('txtNilaiCair3B').getValue(),
				'fs_uangmuka1': Ext.getCmp('txtUangMukaDealerlabelB').getValue(),
				'fs_uangmuka2': Ext.getCmp('txtUangMukaDealer2B').getValue(),
				'fs_skala_perusahaan_konsumen': Ext.getCmp('cboSkalaPerusahaan2B').getValue(),
	...
	function fnResetDuplikatKonsumen(){

						/*Ext.getCmp('txtNoApk').setValue('');
						Ext.getCmp('txtSelisihDp').setValue('');
						Ext.getCmp('txtTotalTrans2').setValue('');
						Ext.getCmp('txtTotalTrans').setValue('');
						//document.getElementById('total_trx').value=xtext.fn_selisih_dp;
						Ext.getCmp('txtNoApkP').setValue('');
						Ext.getCmp('txtNoNpwp').setValue('');
						Ext.getCmp('cboLembagaPembiayaan').setValue('');
						...
						Ext.getCmp('cboUsahaPekerjaan').setValue('');
						Ext.getCmp('txtUsahaPekerjaan').setValue('');
						...
						Ext.getCmp('txtKodeStatusKawin').setValue('');
						...
						Ext.getCmp('txtNilaiAsuransi').setValue('');
						Ext.getCmp('txtTenorMIX').setValue('');
						...
						Ext.getCmp('txtHargaOTRkonsumen').setValue('');
						Ext.getCmp('txtHargaOTRdealer').setValue('');
						Ext.getCmp('txtTenor').setValue('');
						Ext.getCmp('txtTenor2').setValue('');
						Ext.getCmp('txtTenor3').setValue('');
						Ext.getCmp('txtTenor4').setValue('');
						Ext.getCmp('txtTenor5').setValue('');
						...
						Ext.getCmp('txtAlamatIstri').setValue('');
						Ext.getCmp('cboKodePosIstri').setValue('');
						Ext.getCmp('txtTeleponIstri').setValue('');
						Ext.getCmp('txtKabupatenKotaIstri').setValue('');
						Ext.getCmp('cboUsahaKerjaan').setValue('');
						Ext.getCmp('txtKodeuUsahaKerjaan').setValue('');
						Ext.getCmp('txtKeteranganUsahaIstri').setValue('');
						Ext.getCmp('txtAlamatUsahaSuamiIstri').setValue('');
						Ext.getCmp('txtTeleponUsaha').setValue('');
						...
						Ext.getCmp('txtNilaiCair').setValue('');
						Ext.getCmp('txtNilaiCair3').setValue('');
						*/
						frmApkKonsumen.reset();
						winDuplikasiKonsumen.hide();
						vMask.hide();

	}

	function fnResetDuplikatBadanUsaha(){
	...
	//LuxTax();
		...
		Ext.Ajax.request({
			...
			params: {
				...
				'fs_merek_kendaraan': Ext.getCmp('cboModelKendaraan').getValue(),
				'fs_model_kendaraan': Ext.getCmp('txtModelKendaraan').getValue(),
	...
	Ext.Ajax.request({
		...
		success: function(response) {
			...
			if (xtext.sukses === true) {
				...
				var combo3 = Ext.ComponentQuery.query('#idTambah')[0];
				var combo4 = Ext.ComponentQuery.query('#idKoreksi')[0];
				var combo5 = Ext.ComponentQuery.query('#idDuplikasi')[0];
				...
				if(a!='00') {
				 	...
				 	combo3.setDisabled(false);
					combo4.setDisabled(false);
					combo5.setDisabled(false);
				}else {
					combo2.setDisabled(false);
					combo3.setDisabled(true);
					combo4.setDisabled(true);
					combo5.setDisabled(true);
				}				
			}
		},
		failure: function(response) {
